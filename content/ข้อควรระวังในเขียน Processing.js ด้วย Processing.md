...
<a title="เขียน Processing.js ด้วย Processing" href="http://wittawat.com/blog/?p=1447">post ก่อนหน้า</a>ได้เขียนไปแล้วว่าเราสามารถเขียน Processing ทีเดียวแล้วได้ทั้งโปรแกรมบนเครื่องและโปรแกรมบนเว็บโดยการ export แต่จากประสบการณ์ที่ลองใช้ Processing 2.0b8 และ Processing.js 1.4.1  แล้ว ยังมีเรื่องที่แปลกๆอยู่บ้างถ้าไม่ระวัง ดังนี้
<ul>
